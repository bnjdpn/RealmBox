...
const fr = {
  ...
  dialogueLocalProof: "Après le téléchargement, Ollama écoute uniquement sur 127.0.0.1 et le jeu fonctionne sans réseau.", closeToChange: "Le niveau de bavardage s’applique à chaud. Arrêtez le monde uniquement pour activer ou désactiver les dialogues.", stopForDialogues: "Arrêter le monde pour modifier les dialogues",
  ...
  chattiness: "Niveau de bavardage", chattinessQuiet: "Discret · aucun échange bot-à-bot", chattinessBalanced: "Équilibré · échanges bot-à-bot occasionnels", chattinessLively: "Vivant · échanges bot-à-bot plus fréquents", chattinessSaved: "Niveau de bavardage appliqué.",
...
const en: Copy = {
  ...
  dialogueLocalProof: "After download, Ollama only listens on 127.0.0.1 and the game works without a network.", closeToChange: "Chattiness applies live. Stop the world only to enable or disable dialogue.", stopForDialogues: "Stop the world to change dialogue",
  ...
  chattiness: "Chattiness", chattinessQuiet: "Quiet · no bot-to-bot chat", chattinessBalanced: "Balanced · occasional bot-to-bot chat", chattinessLively: "Lively · more bot-to-bot chat", chattinessSaved: "Chattiness applied.",
  ...
  requestedPopulation: "Desired population", appliedPopulation: "Actually applied population", team: "In-game party", teamHelp: "Use the RealmBox addon to form and direct a balanced party of four companions.", applyNow: "Apply now", applied: "Population applied without restarting the client.", startToApply: "Open the world to apply a live change.",
