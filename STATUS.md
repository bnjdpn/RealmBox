...
| Vérification locale courante | réussie | `pnpm verify` : typecheck, lint, 5 tests UI, build web, clippy strict et 35 tests Rust ; le correctif CI des images s’applique proprement au commit serveur épinglé |
