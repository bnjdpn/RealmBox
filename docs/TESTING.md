...
`pnpm capture:launcher` ouvre ces états avec Playwright et régénère quatre captures WebP 1024 × 640 sous `site/public/assets` : prêt en français, installation en français, panneau Compagnons en français et panneau Dialogues en anglais. Le workflow de release exécute le même script et joint les captures au brouillon de release. Ces images ne contiennent aucune ressource du jeu.
